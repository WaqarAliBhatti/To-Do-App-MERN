...
setEditValue(editTodo.todo);
  ...
  return (
<>
{editFormVisibility===false ?  (<form action="" className='form-group custom-form' onSubmit={handleSubmit}>
  <label htmlFor="">Add Your To do Tasks</label>
  ...
  <form action="" className='form-group custom-form' onSubmit={editSubmit}>
  <label htmlFor="">Update Your To do Tasks</label>
  <div className='input-and-btn'>
